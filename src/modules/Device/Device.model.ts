...
const ModbusReadSchema = new Schema(
  {
    readId: {
      type: String,
      required: true,
      immutable: true, // 🔒 Auto-generated by backend, never changes
    },
    slaveId: {
      type: String,
      required: true,
      immutable: true, // 🔒 Reference to parent slave
    },
    portKey: { type: String, required: true }, // 🔑 virtual port
    registerType: {
      type: String,
...
const ModbusSlaveSchema = new Schema({
  ...
  portKey: {
    type: String,
    required: true,
    immutable: true, // 🔒 Reference to parent port (from DeviceModel)
  },
  name: { type: String, required: true },
  serial: {
